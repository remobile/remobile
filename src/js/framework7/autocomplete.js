...
var Autocomplete = function (params) {
    ...
    if (a.params.openIn !== 'dropdown') {
        // Item Template
        a.itemTemplate = app.t7.compile(a.params.itemTemplate ||
            '<li>' +
        ...
        a.navbarTemplate = app.t7.compile(a.params.navbarTemplate ||
        ...
        a.dropdownItemTemplate = app.t7.compile(a.params.dropdownItemTemplate ||
            '<li>' +
        ...
        a.dropdownPlaceholderTemplate = app.t7.compile(a.params.dropdownPlaceholderTemplate ||
        ...
        a.dropdownTemplate = app.t7.compile(a.params.dropdownTemplate ||
