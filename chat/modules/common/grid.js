	...
	render: function() {
		return (
			<View.Page title="Grid">
              ...
              <Content.ContentBlock><p>flexible layout grid</p></Content.ContentBlock>
              <Content.ContentBlockTitle>Columns with gutter</Content.ContentBlockTitle>
              ...
              <Content.ContentBlockTitle>Columns with no gutter</Content.ContentBlockTitle>
              <Content.ContentBlock>
                  <Grid.Row noGutter>
                      <Grid.Col per={50}>50</Grid.Col>
                      <Grid.Col per={50}>50</Grid.Col>
